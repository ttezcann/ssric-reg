...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/nws/nws.dta", temp, mode = "wb")
nws <- haven::read_dta(temp)

...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/ppcs/ppcs.dta", temp, mode = "wb")
ppcs <- haven::read_dta(temp)

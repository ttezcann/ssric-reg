...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/nsha/nsha.dta", temp, mode = "wb")
nsha <- haven::read_dta(temp)

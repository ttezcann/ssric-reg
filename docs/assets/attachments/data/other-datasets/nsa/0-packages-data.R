...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/nsa/nsa.dta", temp, mode = "wb")
nsa <- haven::read_dta(temp)

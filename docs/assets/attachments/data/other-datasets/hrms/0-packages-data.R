...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/hrms/hrms.dta", temp, mode = "wb")
hrms <- haven::read_dta(temp)

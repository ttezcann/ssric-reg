...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/wbns/wbns.dta", temp, mode = "wb")
wbns <- haven::read_dta(temp)

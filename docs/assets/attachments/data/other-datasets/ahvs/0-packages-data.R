...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/other-datasets/ahvs/ahvs.dta", temp, mode = "wb")
ahvs <- haven::read_dta(temp)

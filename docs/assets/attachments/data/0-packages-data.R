...
"sjPlot", "ggpubr", "dplyr", "ggplot2", "gt")
...
download.file("https://github.com/ttezcann/ssric-reg/raw/refs/heads/main/docs/assets/attachments/data/gss.dta", temp, mode = "wb")
...
source(url("https://raw.githubusercontent.com/ttezcann/ssric-reg/refs/heads/main/docs/assets/attachments/data/0-rgss-relabel.R")) 
}))))

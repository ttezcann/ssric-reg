...
2. [[Search]] the variable names, `sex` and `conrinc`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
...
2. [[Search]] the variable names, `sex` and `educ`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
    - | Variable name | Variable label | Variable type | Question wording and response categories |
      |---|---|---|---|
      | `sex` | Respondents' sex | Binary | What's your sex?<br><br>*(1: Male; 2: Female)* |
...
2. [[Search]] the variable names, `marital` and `tvhours`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
    - | Variable name | Variable label | Variable type | Question wording and response categories |
      |---|---|---|---|

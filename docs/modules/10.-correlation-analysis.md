...
2. [[Search]] these variable names in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
...
2. [[Search]] the variable names, `masei10` and `pasei10`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
    - | Variable name | Variable label | Variable type | Question wording and response categories |
      |---|---|---|---|
...
2. [[Search]] the variable names, `hrs1` and `sibs`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
    - | Variable name | Variable label | Variable type | Question wording and response categories |
      |---|---|---|---|

...
- There are three options to use RStudio:
    1. :lucide-cloud: [Create a free RStudio Cloud account](../resources/rstudio-install-usage/#create-a-free-rstudio-cloud-account){: target="_blank"}
    2. :lucide-laptop: [Install R and RStudio to your personal computer](../resources/rstudio-install-usage/#install-r-and-rstudio-to-your-personal-computer){: target="_blank"}
    3. :lucide-computer: [Using RStudio on a university lab computer](../resources/rstudio-install-usage/#using-rstudio-on-a-university-lab-computer){: target="_blank"}
<!-- slide-break -->
# Data: General Social Survey (GSS)
- We'll use [General Social Survey](https://www.norc.org/research/projects/gss.html){: target="_blank" rel="noopener" } ([[GSS]]) for the modules.
...
- We will use several packages. 
    - [Tidyverse](https://tidyverse.org/){: target="_blank" rel="noopener" } is one of the packages we’ll use.

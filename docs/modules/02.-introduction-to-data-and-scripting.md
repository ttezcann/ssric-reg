...
<!-- slide-break -->
    - The information above are provided in the [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} lab resources page. We'll be using this page for all modules.
...
- ![Side-by-side view of a module page and RStudio. The module page on the left shows a “Frequency table code” section with model code and working code examples, while the RStudio window on the right shows the same working code highlighted and the corresponding “Frequency table (for categorical variables)” section in the viewer tab.](../assets/attachments/modules/02.-introduction-to-data-and-scripting/find-this-working-code.png)

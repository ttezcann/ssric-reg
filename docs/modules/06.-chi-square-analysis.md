...
- **[[Is my p-value less than 0.05?]]**
    - To determine [[statistical significance]]
        - We can use this website: [www.whichnumberislarger.com](https://www.whichnumberislarger.com/){: target="_blank" rel="noopener" }.
...
2. [[Search]] the variable names, `degree` and `health`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
...
- !!! success "Interpretation explanation"
    ...
    - **(1) First sentence**: After the **variable label** of the **factor variable**, we add the word "*variable*" in our interpretation:
...
2. [[Search]] the variable names, `sex` and `happy`, in [Variables in GSS](../resources/variables-in-gss.md){: target="_blank"} page.
    - | Variable name | Variable label | Variable type | Question wording and response categories |
      |---|---|---|---|
